...
//add an AddCard method to the PlayerDeck
public class MasterDeck {
     ...
     *
     * @return "Empty Deck" if deck is empty, a card on each line
     * if not
     */
    ...
    /**
     * Returns the top 3 cards of the Deck
     *
     * @return the top 3 cards of the deck as an ArrayList<Card>(),
